...
$(document).ready(function() {
    ...
    $("#addBtn").bind("click", function(){
        $("#tb1").append("<tr><td><td></td><td></td><td class='del-col'><a href='javascript:void(0);' class='delBtn'>删除</a></td></tr>");
        trEdit();
        delTr();
...
function saveCustomers(){
    ...
    $("#tb1 tr").each(function(index,$this){
        dataArray[index]= {"name": $(this).children('td').eq(0).text(),"phone":$(this).children('td').eq(1).text(),
            "desc":$(this).children('td').eq(2).text()}
    });
